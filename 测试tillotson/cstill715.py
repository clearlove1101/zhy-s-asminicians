...
from Equations import Tillotson_new
import config
...
class App(Application):
    ...
    def create_equations(self):
        ...
        equations = [Group(equations=[
            Tillotson_new.TillotsonEOS(dest=name_impactor, sources=None, rho0=rho_impactor, c0=1.5e3, gamma=7),
            Tillotson_new.TillotsonEOS(dest=name_asteroid, sources=None, rho0=rho_asteroid, c0=1.5e3, gamma=7),
        ])]
        return equations
