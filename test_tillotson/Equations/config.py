...
#   <好多方程用>
# ]
e_asteroid = T_asteroid * tillotson_cv * 1e-4
...
# {<m>, <质心坐标>, <->}
center_impactor = [0, 0, rho_impactor + r_asteroid]
...
#   <可以用温度算>
# ]
e_impactor = T_impactor * tillotson_cv * 1e-4
...
# {<度(比弧度制直观)>, <与x、y、z轴夹角>, <右手法则，大拇指是角速度方向，四指是速度方向>}
angle_impactor = [45, 45, 180]

# {<度/s>, <探测器自转角速度，角速度矢量三个分量>, <3维为矢量>}
w_impactor = [0, 0, 0]
